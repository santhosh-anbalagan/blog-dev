...
import { GitHubIcon, InstaIcon, TwitterIcon } from '@/components/Icons';
        ...
        >
          ...
          <ul className={clsx('flex items-center')}>
            <li className={clsx('hidden', 'sm:block')}>
              <NavIcon
                href="https://www.instagram.com/santhoshzsaz"
                icon={<InstaIcon className={clsx('h-5 w-5')} />}
                title="Twitter"
              />
            </li>
            <li className={clsx('hidden', 'sm:block')}>
              <NavIcon
                href="https://github.com/santhosh-anbalagan"
